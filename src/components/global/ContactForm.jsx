  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://backend.rajproperty.site/api/messages",
        {
          method: "POST",
  ...
  return (
    <>
      <Helmet>
        <meta
          name="description"
          content="Contact RajProperty to buy or sell land, flat, or house in Rajshahi City, Bangladesh. Submit your inquiry as a buyer or seller and get trusted service."
        />
        <meta
          name="keywords"
          content="contact, inquiry, RajProperty, buy, sell, land, flat, house, Rajshahi, Bangladesh, agency, real estate"
        />
        <meta
          property="og:title"
          content="Contact RajProperty, Rajshahi City"
        />
        <meta
          property="og:description"
          content="Send your property inquiry to RajProperty. We help clients buy and sell lands, flats, and houses in Rajshahi City, Bangladesh."
        />
